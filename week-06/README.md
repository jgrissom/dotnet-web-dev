...
- **Copy `week-06/demo-starter/Curbside` out of the private answer-keys repo** to a scratch folder — it's Curbside exactly as week 5's demo left it. `dotnet watch`, then park two browser tabs on `/Trucks` and `/Trucks/Details/2`
