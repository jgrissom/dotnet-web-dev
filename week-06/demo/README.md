...
- **The starting app is not in this repo.** Curbside's finished week-5 state lives in the private answer-keys repo at `week-06/demo-starter/Curbside` — copy it out into `~/Repos/dotnet-web-dev-course-trial/instructor/week-06/` before class.
