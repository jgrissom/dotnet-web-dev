...
- **Curbside**, copied out of the private answer-keys repo (`week-05/demo-starter/Curbside`) into `~/Repos/dotnet-web-dev-course-trial/instructor/`, running under `dotnet watch`, with **three browser tabs parked** on `/`, `/Trucks`, `/Trucks/Details/2`
