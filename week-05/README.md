...
The night the app stops looking like a template. Every page you built last week arrived wrapped in a file nobody opened — tonight you open it, break it on purpose, move its footer into a partial, and re-skin the entire site with one line. Lab is the *Cryptid Registry* again, but the app arrives finished: all the work is in `Views/`.
