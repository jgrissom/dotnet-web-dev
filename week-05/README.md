...
- **Copy `week-05/demo-starter/Curbside` out of the private answer-keys repo** into `~/Repos/dotnet-web-dev-course-trial/instructor/` — it's Curbside exactly where week 4 left it. `dotnet watch`, then park three browser tabs on `/`, `/Trucks`, `/Trucks/Details/2`
