...
| 3:05 | 30 min | **Lab: JS Refresher Gauntlet** *(slide 23)*. Launch with ~90 seconds of *what done looks like*: your finished copy in the browser, console showing **8 / 8 passing** — a target, not a walkthrough. Then students clone the **starters** repo — the only one they clone all term — copy `week-01` out, and work exercises 1–8 (`lab/README.md`). Work in pairs encouraged. Review 2–3 trickiest exercises on screen in the last 10 minutes. |
