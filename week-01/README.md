...
| In&nbsp;class,&nbsp;DOM/⁠fetch&nbsp;segment | 🎨&nbsp;[demo/⁠](demo/) | Console playground ([hosted](https://jgrissom.github.io/dotnet-web-dev/week-01/demo/)) + `demo-script.js`: every console example in slide order |
