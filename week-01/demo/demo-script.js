...
// ── typeof (slide 9) — type these one at a time ─────────────
typeof 42
typeof "hello"
typeof undefined
...
// ── Template literals (slide 10) ─────────────────────────────
const name = "Ada";
`Hello, ${name}! You have ${3 + 4} messages.`

// ── Equality (slide 11) — predictions mandatory ──────────────
1 == "1"
1 === "1"
...
// ── fetch (slide 21) — line by line, top-level await ─────────
