...
- `finished.html` — the **DOM & fetch playground**: a minimal page with the `#status` / `#go` elements the slide-20 demo selects. Hosted at **https://jgrissom.github.io/dotnet-web-dev/week-01/demo/** — open that in class (console on, page visible), and students can replay the demo from the same URL at home without cloning anything.
