...
- [ ] Setup on screen, said once: **`git pull` → copy `week-07` out and rename it → open the folder holding *both* projects → `cd Cryptids.Web` and set your connection string in user secrets → `dotnet test Cryptids.Checks`**
