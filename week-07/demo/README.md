...
- **The starting app is not in this repo.** Curbside's finished week-6 state lives in the private answer-keys repo at `week-07/demo-starter/Curbside` — copy it out into `~/Repos/dotnet-web-dev-course-trial/instructor/` before class.
