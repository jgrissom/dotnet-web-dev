...
- **Copy `week-07/demo-starter/Curbside` out of the private answer-keys repo** into `~/Repos/dotnet-web-dev-course-trial/instructor/week-07/` — Curbside exactly as week 6's demo left it. `dotnet watch`, then park tabs on `/Trucks` and `/Trucks/Create`
