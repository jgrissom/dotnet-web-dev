...
| In&nbsp;class,&nbsp;last&nbsp;40&nbsp;min | 🧪&nbsp;[lab/⁠](lab/) | *Cryptid Registry* — 6 `dotnet test` checks; 1/6 green out of the box (answer key in the private answer-keys repo) |
...
- `~/Repos/dotnet-web-dev-course/instructor/week-04/` ready and empty for *Curbside* (week 3's app stays where it is, in `week-03/`) — you create it **live** at the top of the routing segment (demo §0b, 60 seconds), since tonight's homework asks students to do the same thing
