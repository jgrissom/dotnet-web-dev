...
- `finished.html` — where the session ends up (Lux theme + Nunito, hosted as the [**after** page](https://jgrissom.github.io/dotnet-web-dev/week-02/demo/)), for rehearsal and as your own "what done looks like." Opening before and after in two tabs is the fastest "why Bootstrap" pitch there is — same content, transformed almost entirely by *classes*, plus only the structural wrappers Bootstrap genuinely requires (`row`/`col`, `card-body`, the navbar anatomy).
