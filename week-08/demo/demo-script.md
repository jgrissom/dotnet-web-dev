...
- [ ] Open its Details → **Edit this truck**. 🎯 *"pre-filled — that is `FindAsync` and `View(truck)`, `FindAsync` looked the record up and `View(truck)` handed it over, exactly as we read it upstairs in the scaffold"*
